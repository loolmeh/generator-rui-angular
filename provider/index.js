(function(){
    ...
    util.inherits(ProviderGen, Base);
    _$rapyd$_mixin(ProviderGen.prototype, BaseGen);
    _$rapyd$_mixin(ProviderGen.prototype, GenExtra);
    module.exports = ProviderGen;
})();